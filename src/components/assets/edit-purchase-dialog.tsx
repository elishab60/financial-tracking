...
import { Loader2, Calendar, DollarSign, Pencil } from "lucide-react"
import { updatePurchase } from "@/app/actions/purchases"
import { toast } from "sonner"
import { Asset, AssetPurchase } from "@/types"
...
export function EditPurchaseDialog({ asset, purchase, open, onOpenChange }: EditPurchaseDialogProps) {
    ...
    useEffect(() => {
        if (open) {
            // Reset form when dialog opens with current purchase data
            setFormData({
                quantity: purchase.quantity,
                unit_price: purchase.unit_price,
                purchase_date: purchase.purchase_date?.split('T')[0] || '',
            ...
            <DialogContent className="max-w-md bg-[#0a0a0a] border border-white/10 shadow-2xl rounded-3xl overflow-hidden p-0">
                ...
                <div className="p-8 pt-4 space-y-6">
                    ...
                    <div className="space-y-2">
                        ...
                        {historicalPrice && !loadingHistorical && (
                            <button
                                type="button"
                ...
                <div className="p-8 pt-0 flex gap-4">
                    ...
                    <Button
                        ...
                        disabled={loading}
                        className="flex-[2] h-12 premium-button rounded-xl text-[10px] font-black uppercase tracking-[0.2em]"
                    >
